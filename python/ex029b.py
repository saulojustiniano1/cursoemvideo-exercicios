...
if velocidade_do_carro > 80:
    ...
    print('\033[31mMULTADO! Você excedeu o limite permitido que é de R$80Km/h\033[m')  # noqa
    print(
        f'\033[31mVocê deve pagar uma multa de\033[m \033[32mR${multa:.2f}!\033[m')  # noqa
